...
function Card({ country }) {
	return (
		<div className="w-80 bg-white text-veryDarkBlueText dark:bg-darkBlue dark:text-white mx-auto my-10 flex flex-col justify-between rounded-md shadow-md min-h-fit h-96">
			{country ? (
